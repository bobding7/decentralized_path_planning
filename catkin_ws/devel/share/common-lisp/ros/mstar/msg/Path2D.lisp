...
(cl:defmethod cl:initialize-instance :after ((m <Path2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mstar-msg:<Path2D> is deprecated: use mstar-msg:Path2D instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Path2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mstar-msg:id-val is deprecated.  Use mstar-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <Path2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mstar-msg:timestamp-val is deprecated.  Use mstar-msg:timestamp instead.")
  (timestamp m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Path2D>)))
  ...
  (cl:format cl:nil "int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: mstar/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Path2D)))
  "Returns full string definition for message of type 'Path2D"
  (cl:format cl:nil "int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: mstar/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
