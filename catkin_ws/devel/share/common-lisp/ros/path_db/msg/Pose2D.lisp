...
(cl:defmethod cl:initialize-instance :after ((m <Pose2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name path_db-msg:<Pose2D> is deprecated: use path_db-msg:Pose2D instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Pose2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_db-msg:x-val is deprecated.  Use path_db-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Pose2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_db-msg:y-val is deprecated.  Use path_db-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <Pose2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_db-msg:yaw-val is deprecated.  Use path_db-msg:yaw instead.")
  (yaw m))
