...
(cl:defclass <Path2D> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (poses
    :reader poses
    :initarg :poses
    :type (cl:vector path_db-msg:Pose2D)
   :initform (cl:make-array 0 :element-type 'path_db-msg:Pose2D :initial-element (cl:make-instance 'path_db-msg:Pose2D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Path2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name path_db-msg:<Path2D> is deprecated: use path_db-msg:Path2D instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Path2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_db-msg:id-val is deprecated.  Use path_db-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <Path2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_db-msg:timestamp-val is deprecated.  Use path_db-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <Path2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_db-msg:poses-val is deprecated.  Use path_db-msg:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Path2D>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'poses)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'path_db-msg:Pose2D))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Path2D>)))
  ...
  (cl:format cl:nil "int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: path_db/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Path2D)))
  "Returns full string definition for message of type 'Path2D"
  (cl:format cl:nil "int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: path_db/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
