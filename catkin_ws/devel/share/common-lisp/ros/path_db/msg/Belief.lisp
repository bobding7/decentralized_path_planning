...
(cl:defclass <Belief> (roslisp-msg-protocol:ros-message)
  ((belief
    :reader belief
    :initarg :belief
    :type (cl:vector path_db-msg:Path2D)
   :initform (cl:make-array 0 :element-type 'path_db-msg:Path2D :initial-element (cl:make-instance 'path_db-msg:Path2D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Belief>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Belief)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name path_db-msg:<Belief> is deprecated: use path_db-msg:Belief instead.")))

(cl:ensure-generic-function 'belief-val :lambda-list '(m))
(cl:defmethod belief-val ((m <Belief>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_db-msg:belief-val is deprecated.  Use path_db-msg:belief instead.")
  (belief m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Belief>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'belief)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'path_db-msg:Path2D))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Belief>)))
  ...
  (cl:format cl:nil "Path2D[] belief~%~%================================================================================~%MSG: path_db/Path2D~%int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: path_db/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Belief)))
  "Returns full string definition for message of type 'Belief"
  (cl:format cl:nil "Path2D[] belief~%~%================================================================================~%MSG: path_db/Path2D~%int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: path_db/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
