...
(cl:defmethod cl:initialize-instance :after ((m <Belief>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Belief)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_node-msg:<Belief> is deprecated: use control_node-msg:Belief instead.")))

(cl:ensure-generic-function 'belief-val :lambda-list '(m))
(cl:defmethod belief-val ((m <Belief>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_node-msg:belief-val is deprecated.  Use control_node-msg:belief instead.")
  (belief m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Belief>)))
  ...
  (cl:format cl:nil "Path2D[] belief~%~%================================================================================~%MSG: control_node/Path2D~%int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: control_node/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Belief)))
  "Returns full string definition for message of type 'Belief"
  (cl:format cl:nil "Path2D[] belief~%~%================================================================================~%MSG: control_node/Path2D~%int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: control_node/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
