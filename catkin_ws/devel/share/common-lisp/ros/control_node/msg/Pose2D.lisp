...
(cl:defmethod cl:initialize-instance :after ((m <Pose2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_node-msg:<Pose2D> is deprecated: use control_node-msg:Pose2D instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Pose2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_node-msg:x-val is deprecated.  Use control_node-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Pose2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_node-msg:y-val is deprecated.  Use control_node-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <Pose2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_node-msg:yaw-val is deprecated.  Use control_node-msg:yaw instead.")
  (yaw m))
