...
(cl:defclass <QueryDB-request> (roslisp-msg-protocol:ros-message)
  ((type
   ...
   (in_belief
    :reader in_belief
    :initarg :in_belief
    :type control_node-msg:Belief
    :initform (cl:make-instance 'control_node-msg:Belief)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <QueryDB-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryDB-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_node-srv:<QueryDB-request> is deprecated: use control_node-srv:QueryDB-request instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <QueryDB-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_node-srv:type-val is deprecated.  Use control_node-srv:type instead.")
  (type m))

(cl:ensure-generic-function 'in_belief-val :lambda-list '(m))
(cl:defmethod in_belief-val ((m <QueryDB-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_node-srv:in_belief-val is deprecated.  Use control_node-srv:in_belief instead.")
  (in_belief m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<QueryDB-request>)))
  ...
  (cl:format cl:nil "string type~%Belief in_belief~%~%================================================================================~%MSG: control_node/Belief~%Path2D[] belief~%~%================================================================================~%MSG: control_node/Path2D~%int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: control_node/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'QueryDB-request)))
  "Returns full string definition for message of type 'QueryDB-request"
  (cl:format cl:nil "string type~%Belief in_belief~%~%================================================================================~%MSG: control_node/Belief~%Path2D[] belief~%~%================================================================================~%MSG: control_node/Path2D~%int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: control_node/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <QueryDB-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryDB-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_node-srv:<QueryDB-response> is deprecated: use control_node-srv:QueryDB-response instead.")))

(cl:ensure-generic-function 'out_belief-val :lambda-list '(m))
(cl:defmethod out_belief-val ((m <QueryDB-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_node-srv:out_belief-val is deprecated.  Use control_node-srv:out_belief instead.")
  (out_belief m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<QueryDB-response>)))
  ...
  (cl:format cl:nil "Belief out_belief~%~%~%================================================================================~%MSG: control_node/Belief~%Path2D[] belief~%~%================================================================================~%MSG: control_node/Path2D~%int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: control_node/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'QueryDB-response)))
  "Returns full string definition for message of type 'QueryDB-response"
  (cl:format cl:nil "Belief out_belief~%~%~%================================================================================~%MSG: control_node/Belief~%Path2D[] belief~%~%================================================================================~%MSG: control_node/Path2D~%int8 id~%int32 timestamp~%Pose2D[] poses~%~%================================================================================~%MSG: control_node/Pose2D~%float32 x~%float32 y~%float32 yaw~%~%~%"))
