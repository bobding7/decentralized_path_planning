...
"""autogenerated by genpy from path_db/QueryDBRequest.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['string','path_db/Belief']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.in_belief is None:
        self.in_belief = path_db.msg.Belief()
    else:
      self.type = ''
      self.in_belief = path_db.msg.Belief()
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from path_db/QueryDBResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.out_belief is None:
        self.out_belief = path_db.msg.Belief()
    else:
      self.out_belief = path_db.msg.Belief()
